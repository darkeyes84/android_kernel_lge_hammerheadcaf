...
export ARCH=arm;
export SUB_ARCH=arm;
export KERNEL_CONFIG="cyanogenmod_hammerhead_defconfig";

# build script
export USER=`whoami`;
export TMPFILE=`mktemp -t`;
export KBUILD_BUILD_USER="aexon";
export KBUILD_BUILD_HOST="BuildBox";

# system compiler
export CROSS_COMPILE=/home/aexon/toolchains/UBERTC-arm-eabi-6/bin/arm-eabi-
