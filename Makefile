...
KERNELFLAGS		= -std=gnu89 -marm -fopenmp -munaligned-access -fgcse-lm -fgcse-sm -fsched-spec-load -fgcse-after-reload -ffast-math -fsingle-precision-constant -funswitch-loops -fmodulo-sched -fmodulo-sched-allow-regmoves -fpredictive-commoning -mcpu=cortex-a15 -mtune=cortex-a15 -mfpu=neon-vfpv4
